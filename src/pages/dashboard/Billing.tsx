...
import { Calendar, Download, Check, Zap, Star, Crown } from "lucide-react";
...
const Billing = () => {
  ...
  const getGrowthPricing = () => {
    ...
    const displayPrice = isAnnual
      ...
      : Math.round(selectedOption.annualPrice * 1.24);
    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="transition-all duration-300">
          ...
          {activeTab === "history" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              <Card className="border border-gray-200 rounded-3xl p-8">
                ...
                <div className="space-y-4">
                  {billingHistory.map((invoice) => (
                    <div key={invoice.id} className="flex items-center justify-between p-6 border border-gray-200 rounded-2xl hover:border-gray-300 transition-colors">
                      <div>
                        <div className="flex items-center space-x-3 mb-1">
                          <p className="font-semibold text-gray-900 text-lg">{invoice.plan} Plan</p>
